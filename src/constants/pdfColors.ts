...
export const PDF_COLORS = {
  ...
  warning: "#fde047", // Approximately hsl(43, 96%, 50%)
  warningDark: "#d97706",
...
// Alert Box Colors - defined separately to reference base colors
export const PDF_ALERT_COLORS = {
  alertInfo: {
    background: PDF_COLORS.infoBackground,
    border: PDF_COLORS.infoLight,
    text: PDF_COLORS.infoVeryDark,
  },
  alertWarning: {
    background: PDF_COLORS.warningBackground,
    border: PDF_COLORS.warningDark,
    text: PDF_COLORS.warningVeryDark,
    textDark: PDF_COLORS.warningVeryDark,
  },
  alertSuccess: {
    background: PDF_COLORS.successBackground,
    border: PDF_COLORS.successLight,
    text: PDF_COLORS.successVeryDark,
    textDark: PDF_COLORS.successVeryDark,
  },
  alertError: {
    background: PDF_COLORS.errorBackground,
    border: PDF_COLORS.errorLight,
    text: PDF_COLORS.error,
    textDark: PDF_COLORS.errorDark,
  },
} as const;

// Type-safe color access
export type PDFColorKey = keyof typeof PDF_COLORS;
export type PDFAlertColorKey = keyof typeof PDF_ALERT_COLORS;
