...
const benefits = [
  ...
  },
  {
    ...
    description: "Built-in compliance checking for NT building classes. No manual interpretation needed."
  },
  {
  ...
  },
  {
    ...
    description: "Credit alignment for NT projects pursuing Green Star certification or NABERS ratings."
  },
  {
  ...
  },
  {
    ...
    title: "Northern Territory Data",
    description: "Australian EPD materials with NT grid factors, local suppliers, and tropical climate zone support."
  }
];
...
const includedFeatures = [
  ...
  "NT-specific emission factors pre-loaded",
...
export default function LandingMBANT() {
  const { trackEvent } = useAnalytics();
  const { getCampaignAttribution } = useUTMTracking();

  useEffect(() => {
    sessionStorage.setItem('discount_code', 'MBA20NT');
  ...
  return (
    <>
      <SEOHead 
        title="Master Builders NT | 20% Off CarbonConstruct Pro Yearly"
        description="Exclusive offer for MBA Northern Territory members: 20% off your first year of CarbonConstruct Pro. Get Level 1 White Label—your company logo on every carbon report."
        canonicalPath="/lp/mba-nt"
      />
        ...
        <section className="relative py-16 md:py-24 bg-gradient-to-br from-background via-background to-emerald-950/20 overflow-hidden">
          <div className="absolute top-4 left-1/2 -translate-x-1/2">
            <Badge variant="outline" className="bg-amber-500/10 text-amber-600 border-amber-500/30 px-4 py-1.5 text-sm font-medium">
              ...
              Exclusive MBA Northern Territory Offer
            </Badge>
          </div>
          ...
          <div className="container mx-auto px-4 pt-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground/80 max-w-2xl mx-auto mb-8">
                MBA Northern Territory members get 20% off their first year. Hand clients professional carbon reports with YOUR branding—not ours. NCC 2024 Section J compliance built in.
              </p>
              ...
              <p className="text-sm text-muted-foreground mt-4">
                Use code <span className="font-mono font-bold text-emerald-600 bg-emerald-500/10 px-2 py-0.5 rounded">MBA20NT</span> at checkout
              </p>
            </div>
          </div>
        </section>

        {/* NT Grid Factor Highlight */}
        <section className="py-8 bg-emerald-600/10 border-y border-emerald-500/20">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 text-center">
              <div className="flex items-center gap-2">
                <Zap className="h-5 w-5 text-emerald-600" />
                <span className="font-medium">NT Grid Factor: <span className="text-emerald-600 font-bold">0.54 kgCO2e/kWh</span></span>
              </div>
              <div className="hidden md:block h-6 w-px bg-border" />
              <span className="text-muted-foreground">NT's isolated grid—accurate calculations require territory-specific factors</span>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  Why NT Builders Choose CarbonConstruct
                </h2>
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  Built specifically for Australian construction—pre-configured with Northern Territory data and compliance requirements.
                </p>
              </div>
        ...
        <section className="py-16 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  MBA Northern Territory Member Pricing
                </h2>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Join other NT builders using CarbonConstruct to win more tenders with professional carbon reports.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <p className="text-sm text-muted-foreground mt-4">
                Use code <span className="font-mono font-bold text-emerald-600 bg-emerald-500/10 px-2 py-0.5 rounded">MBA20NT</span> at checkout • 14-day free trial • No credit card required
              </p>
            </div>
          </div>
        </section>
