  ...
  return (
    <>
      <SEOHead 
        ...
        description="CarbonConstruct's commitment to digital accessibility and inclusive design for all users in the Australian construction industry. WCAG 2.1 Level AA conformance."
      />
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground space-y-8">
            ...
            <Card className="border-emerald-200 bg-emerald-50/50 dark:bg-emerald-950/20 dark:border-emerald-800">
              ...
              <CardContent className="text-foreground">
                <p className="mb-4">
                  CarbonConstruct aims to conform to the <strong>Web Content Accessibility Guidelines (WCAG) 2.1 Level AA</strong> standards. 
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-foreground">WCAG 2.1 Compliance Details</h2>
              <p>Our application addresses the following WCAG 2.1 success criteria:</p>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <Card>
                  ...
                  <CardContent className="text-sm space-y-2">
                    ...
                    <div className="flex items-start gap-2">
                      <CheckCircle className="h-4 w-4 text-emerald-600 mt-0.5 flex-shrink-0" />
                      <span><strong>2.4.4</strong> Link Purpose (Level A)</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle className="h-4 w-4 text-emerald-600 mt-0.5 flex-shrink-0" />
                ...
                <Card>
                  ...
                  <CardContent className="text-sm space-y-2">
                    <div className="flex items-start gap-2">
                      <CheckCircle className="h-4 w-4 text-emerald-600 mt-0.5 flex-shrink-0" />
                      <span><strong>4.1.1</strong> Parsing (Level A)</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle className="h-4 w-4 text-emerald-600 mt-0.5 flex-shrink-0" />
              ...
              <div className="space-y-3">
                ...
                <div className="p-4 bg-muted/50 rounded-lg">
                  ...
                  <ul className="list-disc pl-6 space-y-1 text-sm">
                    ...
                    <li>Visible focus indicators using <code className="bg-muted px-1 rounded">:focus-visible</code></li>
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li><strong>Browser zoom:</strong> Functional up to 200% magnification</li>
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>Automated Testing:</strong> axe-core accessibility engine integrated in development environment</li>
                ...
                <CardContent className="pt-6">
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <a href="mailto:accessibility@carbonconstruct.com.au" className="text-primary hover:underline">
                        accessibility@carbonconstruct.com.au
                      </a>
                    </div>
                    <div className="flex items-center gap-2">
                      <strong>General Enquiries:</strong> 
                      <a href="mailto:info@carbonconstruct.com.au" className="text-primary hover:underline">
