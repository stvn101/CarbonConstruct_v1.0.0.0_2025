...
const benefits = [
  ...
  },
  {
    ...
    description: "Built-in compliance checking for Tasmanian building classes. No manual interpretation needed."
  },
  {
  ...
  },
  {
    ...
    description: "Credit alignment for Tasmanian projects pursuing Green Star certification or NABERS ratings."
  },
  {
  ...
  },
  {
    ...
    title: "Tasmania-Specific Data",
    description: "Australian EPD materials with TAS grid factors, local suppliers, and regional climate zone support."
  }
];
...
const includedFeatures = [
  ...
  "Tasmania-specific emission factors pre-loaded",
...
export default function LandingMBATas() {
  const { trackEvent } = useAnalytics();
  const { getCampaignAttribution } = useUTMTracking();

  useEffect(() => {
    sessionStorage.setItem('discount_code', 'MBA20TAS');
    
    trackEvent(AnalyticsEvents.CAMPAIGN_PAGE_VIEW, {
      audience: 'mba-tasmania',
  ...
  return (
    <>
      <SEOHead 
        title="Master Builders Tasmania | 20% Off CarbonConstruct Pro Yearly"
        description="Exclusive offer for MBA Tasmania members: 20% off your first year of CarbonConstruct Pro. Get Level 1 White Label—your company logo on every carbon report."
        canonicalPath="/lp/mba-tas"
      />
          ...
          <div className="container mx-auto px-4 pt-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground/80 max-w-2xl mx-auto mb-8">
                MBA Tasmania members get 20% off their first year. Hand clients professional carbon reports with YOUR branding—not ours. NCC 2024 Section J compliance built in.
              </p>
              ...
              <p className="text-sm text-muted-foreground mt-4">
                Use code <span className="font-mono font-bold text-emerald-600 bg-emerald-500/10 px-2 py-0.5 rounded">MBA20TAS</span> at checkout
              </p>
            </div>
          </div>
        </section>

        {/* TAS Grid Factor Highlight */}
        <section className="py-8 bg-emerald-600/10 border-y border-emerald-500/20">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 text-center">
              <div className="flex items-center gap-2">
                <Zap className="h-5 w-5 text-emerald-600" />
                <span className="font-medium">TAS Grid Factor: <span className="text-emerald-600 font-bold">0.14 kgCO2e/kWh</span></span>
              </div>
              <div className="hidden md:block h-6 w-px bg-border" />
              <span className="text-muted-foreground">Australia's cleanest grid—your projects benefit from Tasmania's renewable energy advantage</span>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  Why Tasmanian Builders Choose CarbonConstruct
                </h2>
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  Built specifically for Australian construction—pre-configured with Tasmanian data and compliance requirements.
                </p>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Join other Tasmanian builders using CarbonConstruct to win more tenders with professional carbon reports.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <p className="text-sm text-muted-foreground mt-4">
                Use code <span className="font-mono font-bold text-emerald-600 bg-emerald-500/10 px-2 py-0.5 rounded">MBA20TAS</span> at checkout • 14-day free trial • No credit card required
              </p>
            </div>
          </div>
        </section>
