...
const benefits = [
  ...
  },
  {
    ...
    description: "Built-in compliance checking for Western Australian building classes. No manual interpretation needed."
  },
  {
    icon: <Zap className="h-6 w-6" />,
    title: "WA Grid Factor (0.64 kgCO2e/kWh)",
    description: "Western Australia's isolated grid means unique emission factors. Our calculations use your actual state data."
  },
  {
    icon: <Award className="h-6 w-6" />,
    title: "Green Star & NABERS Ready",
    description: "Credit alignment for WA projects pursuing Green Star certification or NABERS ratings."
  },
  {
  ...
  },
  {
    ...
    title: "Western Australia-Specific Data",
    description: "Australian EPD materials with WA grid factors (0.64), local suppliers, and regional climate zone support."
  }
];
...
export default function LandingMBAWA() {
  const { trackEvent } = useAnalytics();
  const { getCampaignAttribution } = useUTMTracking();

  useEffect(() => {
    sessionStorage.setItem('discount_code', 'MBA20WA');
    
    trackEvent(AnalyticsEvents.CAMPAIGN_PAGE_VIEW, {
      audience: 'mba-western-australia',
  ...
  return (
    <>
      <SEOHead 
        title="Master Builders Western Australia | 20% Off CarbonConstruct Pro Yearly"
        description="Exclusive offer for MBA Western Australia members: 20% off your first year of CarbonConstruct Pro. Get Level 1 White Label—your company logo on every carbon report."
        canonicalPath="/lp/mba-wa"
      />
        ...
        <section className="relative py-16 md:py-24 bg-gradient-to-br from-background via-background to-emerald-950/20 overflow-hidden">
          <div className="absolute top-4 left-1/2 -translate-x-1/2">
            <Badge variant="outline" className="bg-amber-500/10 text-amber-600 border-amber-500/30 px-4 py-1.5 text-sm font-medium">
              ...
              Exclusive MBA Western Australia Offer
            </Badge>
          </div>
          ...
          <div className="container mx-auto px-4 pt-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground/80 max-w-2xl mx-auto mb-8">
                MBA Western Australia members get 20% off their first year. Hand clients professional carbon reports with YOUR branding—not ours. NCC 2024 Section J compliance built in.
              </p>
              ...
              <p className="text-sm text-muted-foreground mt-4">
                Use code <span className="font-mono font-bold text-emerald-600 bg-emerald-500/10 px-2 py-0.5 rounded">MBA20WA</span> at checkout
              </p>
            </div>
          </div>
        </section>

        {/* WA Grid Factor Highlight */}
        <section className="py-8 bg-emerald-600/10 border-y border-emerald-500/20">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 text-center">
              <div className="flex items-center gap-2">
                <Zap className="h-5 w-5 text-emerald-600" />
                <span className="font-medium">WA Grid Factor: <span className="text-emerald-600 font-bold">0.64 kgCO2e/kWh</span></span>
              </div>
              <div className="hidden md:block h-6 w-px bg-border" />
              <span className="text-muted-foreground">WA's isolated SWIS grid—accurate calculations require state-specific factors</span>
            </div>
          </div>
        </section>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">Perth CBD Development</span>
                        </div>
                        <div className="flex justify-between">
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Why Western Australian Builders Choose CarbonConstruct
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <Card className="border-2 border-emerald-500 relative">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                    <Badge className="bg-emerald-600">MBA WA Member</Badge>
                  </div>
                  <CardContent className="p-6">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid md:grid-cols-4 gap-8 text-center mb-12">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">WA Grid Factor</div>
                </div>
                <div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Join Western Australian builders who've upgraded from spreadsheets and consultants to professional, branded carbon reports they can actually control.
              </p>
              ...
              <p className="text-sm text-muted-foreground mt-4">
                Use code <span className="font-mono font-bold text-emerald-600">MBA20WA</span> • Offer valid for MBA Western Australia members
              </p>
            </div>
          </div>
        </section>
